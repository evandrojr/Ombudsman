 ...
 */
public class EditarFuncionarioAction extends ActionSupport {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            Funcionario funcionario = adminFuncionario.get(id);
            ...
            request.setAttribute("FuncionarioForm", funcionario);
