...
/**
 * Histórico Esta classe representa os registros históricos das operações
 * realizadas pelos funcionários usuários do sistema.
 * 
 * @author SERPRO
 * @version $Revision: 1.1.2.3 $, $Date: 2011/10/20 17:07:44 $
 * @version 0.1, Date: 2004/11/19
 */
public class Historico extends PersistentObject {
