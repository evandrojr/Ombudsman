...
/**
 * Objetivo: Chamar a tela de entrada de parámetros para a consulta de scripts
 * passando uma string de busca e a lista de assuntos.
 * 
 * @author SERPRO
 * @version $Revision: 1.1.2.4 $, $Date: 2011/10/18 17:57:04 $
 * @version 0.1, Date: 2004/12/08
 */
public class ConsultarScriptAction extends ActionSupport {
    /**
