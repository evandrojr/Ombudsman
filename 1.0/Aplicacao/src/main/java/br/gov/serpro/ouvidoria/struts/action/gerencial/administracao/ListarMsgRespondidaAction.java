...
/**
 * Objetivo: Listar as mensagens respondidas de acordo com os parâmetros
 * informados
 * 
 * @author SERPRO
 ...
 */
public class ListarMsgRespondidaAction extends ActionSupport {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        String lDatIni = _form.getString("txtDataIni");
        String lDatFim = _form.getString("txtDataFim");
        ...
        request
                .setAttribute("totalMsg", String
                        .valueOf(lstAcionamentos.size()));
