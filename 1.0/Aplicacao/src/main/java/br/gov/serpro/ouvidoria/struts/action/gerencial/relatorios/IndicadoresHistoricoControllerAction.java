 ...
 */
public class IndicadoresHistoricoControllerAction extends ActionSupport {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			System.out.println("ERRO::::>>> " + t.getMessage().toString());
			System.out.println("ERRO::::>>> " + t.getCause().toString());
