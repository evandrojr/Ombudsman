 ...
 * soluções, passando para a mesma a lista de assuntos.
 * 
 * @author SERPRO
 * @version $Revision: 1.1.2.3 $, $Date: 2011/10/18 17:57:03 $
 * @version 0.1, 2004/11/30
 */
public class ConsultarSolucaoAction extends ActionSupport {
...
//    	Recupera o Funcionário logado
        ...
        request.setAttribute("lstAssuntos", lstAssuntoFunc);
