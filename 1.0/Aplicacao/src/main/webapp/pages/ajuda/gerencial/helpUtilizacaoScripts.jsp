...
<tr>
 <td align="center" class="titulo" align="center">
 	<label tabindex=1 id="titulo"><b>Utilização de Scripts</b></label>
 </td>
</tr>
<tr>
 <td align="center"><br>
 ...
 <td>  
	 <table border="0" cellpadding="5" cellspacing="0" align="center" width="100%">		
		...
		<tr>
			...
			<td valign="top">
				<label tabindex="11">Campo para seleção de um assunto de mensagem dentre os cadastrados pela ouvidoria.</label>
			</td>
		</tr>
		<tr>
			<td align="left" height="40" width="150" valign="top">
			...
			<td valign="top">
				<label tabindex="13">Campo para seleção do estado do script.</label>
			</td>
		</tr>		
		<tr>
			<td align="left" height="40" width="150" valign="top">
			...
			<td valign="top">
				<label tabindex="15">Será comparada com o conte&uacute;do do nome e da descrição dos scripts disponíveis.</label>
			</td>
		</tr>	
		<tr>
	  ...
	  <table border="0" cellpadding="5" cellspacing="0" align="center" width="100%">		
		...
		<tr>
			<td height="40" colspan="2" valign="top">				
					<label tabindex="18">Local onde são mostrados os scripts cadastrados no sistema. São presentes os dados:</label>
			</td>
		</tr>
		<tr>
			<td align="left" height="40" valign="top">
				<DD>
					<label tabindex="19"><b>Título</b></label>
				</DD>
			</td>
			<td valign="top">
				<label tabindex="20">Título e n&uacute;mero de registro dos scripts encontrados.</label>
			</td>
		</tr>	
		<tr>
			<td align="left" height="40" valign="top">
		...
		<tr>
			<td align="left" height="40" valign="top">
				<DD>
					<label tabindex="23"><b>Qtd Utilização</b></label>
				</DD>
			</td>
			<td valign="top">
				<label tabindex="24">Quantidade de vezes que o script já atendeu a uma solicitação.</label>
			</td>
		</tr>				
	  </table>
	  <br><br>
	  <table border="0" cellpadding="5" cellspacing="0" align="center" width="100%">		
		<tr>
			<td height="30" colspan="2" valign="top">
				<label tabindex="25"><b>2.1 - Está disponível o recurso de paginaçã com as operações:</b></label>
			</td>
		</tr>			
		<tr>
	  ...
	  <table border="0" cellpadding="5" cellspacing="0" align="center" width="100%">		
		...
		<tr>
			...
			<td valign="top">
				<label tabindex="29">Campo para digitação do tipo de assunto de mensagem</label>
			</td>
		</tr>	
		<tr>
			<td align="left" height="40" width="150" valign="top">
			...
			<td valign="top">
				<label tabindex="31">Campo para digitação do título de identificação do script.</label>
			</td>
		</tr>			
		<tr>
			<td align="left" height="40" width="150" valign="top">
			...
			<td valign="top">
				<label tabindex="33">Campo para digitação do texto do script.</label>
			</td>
		</tr>									
		<tr>
			<td height="40" colspan="2" valign="top">
				<label tabindex="34">Está disponível o botão que opera sobre o usuário:</label>
			</td>
		</tr>
		<tr>
			<td align="left" height="40" width="150" valign="top">
	...
	<tr>
	 <td>
		<hr>
		  <p class="voltar"><A title="imprimir esta página" href="javascript:window.print()" tabindex="37">imprimir</A> 
		    . <A title="topo da página" href="javascript:window.location=location.href;" tabindex="38">topo</A>
	 </td>
	</tr>
</table> 	    
</body>	
