...
<tr>
 ...
 <tr>
  <td>
  <DD><label tabindex="6">
  		Possibilita que sejam extraídos relatórios que fazem uma comparação entre indicadores da ouvidoria e indicadores externos advindos de pesquisa no mercado, tendo como universo o total de acionamentos cadastrados ouvidoria em um determinado período.
	</label></DD>  
  </td>
 </tr> 
 <tr>
	 ...
	 <table border="0" cellpadding="5" cellspacing="0" align="center" width="100%">		
		...
		<tr>
			<td height="40" colspan="2" valign="top">				
					<label tabindex="8">
					Serve para criar Indicadores Externos específicas, listando apenas as que correspondem ao crit&eacute;rio de busca selecionado.<br>
		...
		<tr>
			...
			<td valign="top">
				<label tabindex="12">Campo para digitação do período no qual o relatório será baseado.</label>
			</td>
		</tr>	
		<tr>
			<td align="left" height="40" width="40%" valign="top">
				<DD><label tabindex="13"><b>Tipo de Gráfico</b></label></DD>
			</td>
			<td valign="top">
				<label tabindex="14">Campo para seleção do tipo de gráfico que será gerado no relatório.</label>
			</td>
		</tr>	
		<tr>
			<td align="left" height="40" width="40%" valign="top">
				<DD><label tabindex="15"><b>Nº de Ouvidorias para Comparação de dados</b></label></DD>
			</td>
			<td valign="top">
				<label tabindex="16">Campo para seleção do n&uacute;mero de ouvidorias que serão consideradas no relatório.</label>
			</td>
		</tr>	
		<tr>
			<td align="left" height="40" width="40%" valign="top">
			...
			<td valign="top">
				<label tabindex="18">Campo para seleção do modo que os dados serão agrupados na geração do relatório.</label>
			</td>
		</tr>	
		<tr>
			<td align="left" height="40" width="40%" valign="top">
				<DD><label tabindex="19"><b>N&uacute;mero máximo de sub-órgãos/localidades</b></label></DD>
			</td>
			<td valign="top">
				<label tabindex="20">N&uacute;mero máximo de sub-órgãos/localidades que poderão ser selecionados para geração do relatório.</label>
			</td>
		</tr>	
		<tr>
			<td align="left" height="40" width="40%" valign="top">
				<DD><label tabindex="21"><b>Sub-órgão</b></label></DD>
			</td>
			<td valign="top">
				<label tabindex="22">Campo para pr&eacute;-seleção dos sub-órgãos nos quais o relatório será baseado.</label>
			</td>
		</tr>	
		<tr>
			<td align="left" height="40" width="40%" valign="top">
			...
			<td valign="top">
				<label tabindex="24">Campo para pr&eacute;-seleção das localidades dos sub-órgãos nas quais o relatório será baseado.</label>
			</td>
		</tr>	
		<tr>
			<td align="left" height="40" width="40%" valign="top">
				<DD><label tabindex="25"><b>Localidades dos Sub-órgãos</b></label></DD>
			</td>
			<td valign="top">
				<label tabindex="26">
		...
		<tr>
			...
			<td valign="top">
				<label tabindex="28">Campo para digitação no nome das ouvidorias externas. O n&uacute;mero de campos mostrados será de acordo com o n&uacute;mero de ouvidorias selecionado para comparação de dados.</label>
			</td>
		</tr>	
		<tr>
			<td align="left" height="40" width="40%" valign="top">
				<DD><label tabindex="29"><b>Período</b></label></DD>
			</td>
			<td valign="top">
				<label tabindex="30">Campo para digitação dos dados de ouvidorias externas, que serão comparados aos dados dessa ouvidoria para geração do gráfico. O nome desse campo varia de acordo com o modo de agrupamento dos dados e o período selecionados, podendo ser dias da semana, meses do ano etc.</label>
			</td>
		</tr>	
		<tr>
