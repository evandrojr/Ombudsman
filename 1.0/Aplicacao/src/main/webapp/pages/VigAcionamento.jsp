...
<div id="content">
  ...
  <br>
	...
	Informamos que o período para cadastro de acionamentos &eacute; de <bean:write name="_ORGAO_" property="dataInicioAcionamento" format="dd/MM/yyyy"/> at&eacute; <bean:write name="_ORGAO_" property="dataFimAcionamento" format="dd/MM/yyyy"/>.<br><br>
