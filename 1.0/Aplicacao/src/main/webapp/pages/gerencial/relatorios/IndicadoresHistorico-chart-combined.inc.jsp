...
--%>
Local: <%= (String) pageContext.getAttribute("i_local") %><hr>
<cewolf:chart 
    id='serproChart-<%= (String) pageContext.getAttribute("i_local") %>' 
    ...
    <cewolf:data>
        <cewolf:producer id="pieData">
            ...
            <cewolf:param name="i_local" value="<%= (String) pageContext.getAttribute("i_local") %>"/>
...
<cewolf:img 
		...
		border="0"
    chartid='serproChart-<%= (String) pageContext.getAttribute("i_local") %>'
    renderer="/cewolf"
    width="600" 
    height="320"
    mime="<%= params.getMimeType() %>"/>

<p><script type="text/javascript" charset='iso-8859-1'>
imgURLIt = '<cewolf:imgurl 
	chartid='serproChart-<%= (String) pageContext.getAttribute("i_local") %>'    
	renderer="/cewolf"
    width="600" 
    height="320"
