...
<div id="content">
<h1 tabindex="1" id="MsgInicial" title="Autorizar Scripts" tabindex="1">Autorizar Scripts</h1>

<table cellpadding="0" cellspacing="0" border="0"  width="100%">
	<tr>
		<td>
			<iframe tabindex="2" src="../../../gerencial/ListarScriptsPend.do" id="lista" name="lista" longdesc="listagem" width="100%" height="0" scrolling="0" marginwidth="0" marginheight="0" frameborder="0"></iframe>
		</td>
	</tr>
	<tr>
		<td>
