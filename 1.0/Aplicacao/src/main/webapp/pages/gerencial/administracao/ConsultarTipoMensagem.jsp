...
<html lang="pt">
	...
	<body onLoad="javascript:onLoad();">
		...
		<div id="content">
			<h1 id="titulo" title="manter tabela de tipos de mensagem" tabindex="1">Manter tabela de Tipos de Mensagem</h1>
			<table cellpadding="0" cellspacing="0" border="0"  width="100%">
				<tr>
					<td>
						<iframe tabindex="2" src="../../../gerencial/AtualizarTipoMensagem.do?action=listar" tabindex="11" id="lista" name="lista" longdesc="listagem" width="100%" height="200" scrolling="0" marginwidth="0" marginheight="0" frameborder="0"></iframe>
					</td>
				</tr>
				<tr>
					<td height="4">
