...
<html lang="pt">
    ...
    <body style="margin: 0px 0px;" onload="javascript:onLoad();">
        ...
        <tr>
            <td>
                <a href="javascript:void(0);" id="imgLista" title="Lista de Sub-Órgãos"><img id="imgLista" accesskey="l" src="../../<bean:write name="_LAYOUT_" property="esquemaCores"/>/pasta_lista.gif"></a><table STYLE="table-layout:fixed" width="100%" name="rsTable" id=rsTable  cellpadding='2' cellspacing='1' border='0' width="100%">

                <tr> 
                    <td width="60%"></td>
                    <td width="40%" align="center"> 
                        <div align="center"> 
                            <input accesskey="i" title="incluir novo sub-órgão" type="button"]
                            style="width: 200px" value="Incluir Novo Sub-Órgão"
                ...
                <display:table cellpadding="2" cellspacing="1" style="width: 100%"
                    ...
                    <display:column headerClass="tdHeader1" style="width: 60%" title="Sub-Órgão">
