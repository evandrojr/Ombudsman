...
<html lang="pt">
    ...
    <body style="margin: 0px 0px;">
        ...
        <table border="0" width="100%" cellpadding="0" cellspacing="0">
            <tr>
                <td align="left">
                <a href="javascript:void(0);" id="imgLista" title="Lista de Tipos de Assunto"><img accesskey="l" id="imgLista" src="../../<bean:write name="_LAYOUT_" property="esquemaCores"/>/pasta_lista.gif"></a></td>
            </tr>
            <table STYLE="table-layout:fixed" width="100%" id=rsTable cellpadding='2' cellspacing='1' border='0' width="100%">
                <tr>
                    <td width="40%" align=left>
                        <div align="left">
                            <input	accesskey="i" title="Incluir Assunto" type="button" 
                            style="width: 150px;" value="Incluir Assunto" class="button"
                            onClick="link('detalhe', '../../../gerencial/AtualizarTipoAssunto.do?action=exibir&function=incluir');">
                        </div>
                    </td>
                </tr>
            </table>   			
            ...
            <tr>
                <td>
                    ...
                    <display:table cellpadding="2" cellspacing="1" style="width: 100%"
                        ...
                        requestURI="../../../gerencial/AtualizarTipoAssunto.do?action=listar">
                        ...
                        <display:column headerClass="tdHeader1Left" style="width: 50%" title="Tipo de Assunto">
                            <a target="detalhe" href="../../../gerencial/AtualizarTipoAssunto.do?action=exibir&function=alterar&id=<bean:write name="object" property="id"/>">
                                <bean:write name="object" property="descricao"/>
                            </a>
                        </display:column>

                        <display:column headerClass="tdHeader1Left" style="width: 20%" title="Órgão">
                            <a target="detalhe" href="../../../gerencial/AtualizarTipoAssunto.do?action=exibir&function=alterar&id=<bean:write name="object" property="id"/>">
                                <bean:write name="object" property="instituicao.descricao"/>
                            </a>
                        </display:column>
