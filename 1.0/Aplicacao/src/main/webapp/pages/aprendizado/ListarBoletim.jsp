			...
			<tr>
				<td>
					...
					<display:table cellpadding="2" cellspacing="1" style="width: 100%" name="listar" id="boletim" pagesize="20" requestURI="../../aprendizado/AtualizarBoletim.do?action=listar">
						...
						<display:column headerClass="tdHeader1" style="width: 15%" title="Data de Criação">
							<div align="center">
						...
						<display:column headerClass="tdHeader1" style="width: 20%" title="Operação">
							<div align="center">
								<input title="historico de envio" type="button" style="width: 150px;" value="Histórico de Envio" class="button"
